...
$repoBlock = @(
    ...
    "  platform_skill: $(Join-RepoPath $frontend @('src','services','platformSkillService.ts'))"
    "  platform_agent_registry: $(Join-RepoPath $frontend @('src','services','platformAgentRegistryService.ts'))"
    "  platform_tool_catalog: $(Join-RepoPath $frontend @('src','services','platformToolCatalogService.ts'))"
    "  platform_model_provider: $(Join-RepoPath $frontend @('src','services','platformModelProviderService.ts'))"
    "  platform_uncovered_intent: $(Join-RepoPath $frontend @('src','services','platformUncoveredIntentService.ts'))"
    "  platform_mcp_admin: $(Join-RepoPath $frontend @('src','services','platformMcpAdminService.ts'))"
    "  platform_admin_common: $(Join-RepoPath $frontend @('src','services','platformAdminCommon.ts'))"
    "  platform_suspended_workflow: $(Join-RepoPath $frontend @('src','services','platformSuspendedWorkflowService.ts'))"
