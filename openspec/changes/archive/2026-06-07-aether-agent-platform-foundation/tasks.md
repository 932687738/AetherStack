...
- [x] 1.4 **AUTO-UT**：`ToolResultTest` — ok/fail 工厂方法 — **可验证**：`mvn -Dtest=ToolResultTest test` 通过 trace: TC-REQ ToolResultTest
...
- [x] 2.4 **AUTO-UT**：`MyBatisAgentRegistryRepositoryTest` — **可验证**：见 gap G11.1 trace: TC-REQ MyBatisAgentRegistryRepositoryTest
...
- [x] 3.4 **AUTO-UT**：`AgentRegistryApplicationServiceTest` — **可验证**：见 gap G11.2 trace: TC-REQ AgentRegistryApplicationServiceTest
...
- [x] 4.4 **AUTO-UT**：`AgentRegistryControllerTest`（MockMvc）— **可验证**：见 gap G11.3 trace: TC-REQ AgentRegistryControllerTest
...
- [x] 5.4a **AUTO-AI-UT**（**先测后码**）：`NamedChatClientModelRouterTest` — Mock ChatClientBuilder，断言 taskType→model 映射 — **可验证**：红→绿 trace: TC-REQ NamedChatClientModelRouterTest
- [x] 5.4 **AUTO-AI-UT**：`SpringAiLlmCompletionAdapterTest` — Mock 流式返回 — **可验证**：StepVerifier 通过 trace: TC-REQ SpringAiLlmCompletionAdapterTest
...
- [x] 6.4a **AUTO-AI-UT**（**先测后码**）：`PlatformRouterFacadeTest` — Mock LlmRouter + Repository，断言 Prompt 含 capability_description、无 ToolCatalog — **可验证**：红→绿 trace: TC-REQ PlatformRouterFacadeTest
- [x] 6.4 **AUTO-AI-UT**：`SuperAgentHubLlmRouterTest` — **可验证**：见 gap G1.4a trace: TC-REQ SuperAgentHubLlmRouterTest
...
- [x] 7.4a **AUTO-AI-UT**（**先测后码**）：`PrepareSuperAgentChatNodeTest` — Mock PlatformRouterFacade，断言 STREAM_ROUTE 写入 — **可验证**：红→绿 trace: TC-REQ PrepareSuperAgentChatNodeTest
...
- [x] 8.4a **AUTO-AI-UT**：`PlatformAgentAdapterTest` — **可验证**：见 gap G2.4a trace: TC-REQ PlatformAgentAdapterTest
...
- [x] 9.4a **AUTO-AI-UT**（**先测后码**）：`SuperAgentChatApplicationServiceTest` — Mock Graph + 三分支 StepVerifier — **可验证**：红→绿 trace: TC-REQ SuperAgentChatApplicationServiceTest
...
- [x] 10.4a **AUTO-AI-UT**：`PlatformRouterFacadeStickyTest` — **可验证**：见 gap G5.3 trace: TC-REQ PlatformRouterFacadeStickyTest
...
- [x] 11.4 **AUTO-UT**：`RagPlatformToolTest` — Mock Port 返回片段 — **可验证**：ToolResult.success trace: TC-REQ RagPlatformToolTest
...
- [x] 13.4 **AUTO-UT**：`SuperAgentChatTraceIdTest` — **可验证**：见 gap G7.3 trace: TC-REQ SuperAgentChatTraceIdTest
